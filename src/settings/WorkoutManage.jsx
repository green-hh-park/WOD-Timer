...
export default function WorkoutManage({ route, navigation }) {
  const sampleData = [
    {
      title: "Fran",
    ...
    <View style={styles.settingContainer}>
      ...
      <View style={{ width: "100%", backgroundColor: "#fff", height: 170 }}>
        ...
        <View style={{ width: "100%", alignItems: "center" }}>
          ...
          >
            <Pressable onPress={() => navigation.navigate("WorkoutSetting")}>
              <img
            ...
            <Text style={{ fontSize: 20, fontWeight: "bold" }}>운동 관리</Text>
            <Text></Text>
          </View>
          <View
            style={{
